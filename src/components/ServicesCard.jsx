    ...
    return (
        <div id='service' className='py-10 lg:pt-24 lg:pb-20 md:py-16 bg-bg_gradient'>
            <div className='max-w-[1320px] container'>
                ...
                <p className=' font-medium text-gray text-xl sm:text-xxl text-center mx-auto md:leading-7 lg:max-w-[500px] md:pt-3 pt-2 lg:pt-5'>Tweak anything and everything to ensure fits your business, not the other way around.</p>
