            ...
            <div className=' lg:mt-9 md:mt-5 mt-2  lg:min-h-screen xl:min-h-[810px]  min-h-[600px]  overflow-hidden  relative' id='Home'>
                ...
                <div className='mt-14 lg:z-10 relative'>
                    <div className='max-w-[1140px] px-3 mx-auto '>
                        <h2 className='  font-bold text-center text-white  text-3xl2 sm:text-6xl lg:text-7xl leading-10  lg:leading-19'>Unleash <span className=' text-transparent bg-text-gradient bg-clip-text'>Creativity,</span>
